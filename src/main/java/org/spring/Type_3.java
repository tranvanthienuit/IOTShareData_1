...
public class Type_3 {
    public static void main(String[] args) {
        ...
        for (String itemAddress : dataTrain) {
            System.out.println("WordItem" + parentItem + "|" + itemAddress + ",False,True,False,,,0,,,False,\\,True,,0,,False,,3,0,False,False,True,False,False,0,0,False,0,0,False,0,False,0,False,False,12,False,12,,,,,,,,,,True,False,0,0,True,0,0,WordItem" + itemAddress + "," + offset + "," + dataType + ",1,1,1,False,0,0,True,0,0,0,0,False,2\n");
        }
    }
}